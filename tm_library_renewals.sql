...
CREATE TABLE `renewals` (
  ...
  CONSTRAINT `renewals_ibfk_1` FOREIGN KEY (`borrowing_id`) REFERENCES `borrowings` (`borrowing_id`)
...
INSERT INTO `renewals` VALUES (50001,40001,'2022-01-10'),(50002,40002,'2022-02-10');
